  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "box-dark":
          "radial-gradient(51.95% 152.6% at 26.24% -102.6%, rgba(5, 173, 191, 0.32) 0%, rgba(5, 173, 191, 0) 100%), linear-gradient(144.05deg, #32383E -69.07%, #17191C 122.22%)",
        "buttons-box-dark":
      ...
      boxShadow: {
        ...
        "orange-dark":
          "-16px 20px 40px rgba(5, 173, 191, 0.35), -2px 2px 24px rgba(5, 173, 191, 0.6), -16px 28px 120px rgba(5, 173, 191, 0.15)",
        'switcher':
